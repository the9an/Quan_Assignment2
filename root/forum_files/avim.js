...
function AVIM()	{
	...
	if(AVIMGlobalConfig.showControl) {
		...
		document.write('<p class="AVIMControl">TGTH chạy tốt nhất với FireFox. Bộ gõ: <input id="avim_auto" type="radio" name="AVIMMethod" onclick="AVIMObj.setMethod(0);" /> Tự động ');
